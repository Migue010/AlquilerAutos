...
public class PanelLineaTelefonica1 extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelLineaTelefonica1(PrincipalLineas linea) {
		this ();
		this.linea =  linea;
	}
	public PanelLineaTelefonica1() {
		setBackground(new Color(240, 240, 240));
		setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Linea 1", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(64, 224, 208)));
		...
		btnAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int minutos = tomarMinutosLinea1();
				linea.tomarLlamadasLineasTelefonicas(tipo, minutos, 1);
				linea.tomarDatosLinea1();
			}
		});
		add(btnAgregar);
...
public int tipoLlamadaTelefonica() {
	...
	public int tomarMinutosLinea1() {
		String MinutosX = textMinutosLlamada.getText();
		int Minutos = Integer.parseInt(MinutosX);
		return Minutos;
	}

	
	public void mostrarLinea1(double valorTotal, int llamadas, int minutos) {
